    ...
    <nav x-show="open" x-cloak id="mobile-menu" class="md:hidden border-t">
        <div class="px-4 pt-2 pb-3 space-y-1">
            <a href="{{ route('livestock.index') }}"
               class="block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('livestock.*') ? 'text-indigo-600' : 'text-gray-700 hover:text-indigo-600' }}">
                Livestock
            </a>
            <a href="{{ route('crops.index') }}"
               class="block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('crops.*') ? 'text-indigo-600' : 'text-gray-700 hover:text-indigo-600' }}">
                Crops
            </a>
            <a href="{{ route('forestry.index') }}"
               class="block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('forestry.*') ? 'text-indigo-600' : 'text-gray-700 hover:text-indigo-600' }}">
                Forestry
            </a>
            <a href="{{ route('fisheries.index') }}"
               class="block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('fisheries.*') ? 'text-indigo-600' : 'text-gray-700 hover:text-indigo-600' }}">
                Fisheries
            </a>
            <a href="{{ route('facilities.index') }}"
               class="block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('facilities.*') ? 'text-indigo-600' : 'text-gray-700 hover:text-indigo-600' }}">
                Facilities
            </a>
            <a href="{{ route('media.index') }}"
               class="block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('media.*') ? 'text-indigo-600' : 'text-gray-700 hover:text-indigo-600' }}">
                Media
            </a>
            <a href="{{ route('contactus.index') }}"
               class="block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('contactus.*') ? 'text-indigo-600' : 'text-gray-700 hover:text-indigo-600' }}">
                Contact Us
            </a>
                          ...
                          <!-- Dxsn code end -->
<!-- banner img -->
{{-- Image Banner (below nav) --}}
<section class="relative mt-16 sm:mt-20">
    <div class="relative h-56 sm:h-72 md:h-[28rem]">
        {{-- Put your image in public/images/hero.jpg or use storage (see note below) --}}
        <img
    src="{{ asset('images/infohub_banner2.png') }}"
...
<!-- end bannaer img -->
              ...
              <a href="#" class="mt-1 block text-lg font-semibold hover:underline">Revealing tax evasion in agrifood sectors</a>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    ...
                    &copy; {{ date('Y') }} NARO infoHub. All Rights Reserved.
                    </div>
                </div>
            </div>
        </div>
